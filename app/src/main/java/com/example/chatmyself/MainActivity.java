...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            TextView textView = findViewById(R.id.sms1);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*
                This line of code gets an instance of NotificationManager in Android.
                NotificationManager is a system class used to send notifications that are visible to the user.
                 */
